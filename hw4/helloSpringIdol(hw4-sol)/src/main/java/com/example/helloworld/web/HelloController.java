...
public class HelloController {
	...
	public ModelAndView helloAndPerform1(			
		...
		String result = performer.perform();
	...
	public ModelAndView helloAndPerform2(			
		...
		return helloAndPerform1(id, requester);
	}

	@RequestMapping("/performUsingComm")		// request handler method
	public String helloAndPerformUsingComm(PerformReq request, Model model) {	// command class 이용		
